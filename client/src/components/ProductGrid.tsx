...
const ProductGrid = () => {
  const products: Product[] = [
    ...
    {
      id: "4",
      name: "No Chicken Legs Allowed",
      price: 32000, // Black variant price
      image: "/lovable-uploads/8fb5a5d8-283f-4bf4-bad0-01737a7d69ec.png",
      images: {
        "Black": "/lovable-uploads/8fb5a5d8-283f-4bf4-bad0-01737a7d69ec.png",
        "Acid Washed": "/lovable-uploads/198958e9-b920-4824-b316-0705224bfe40.png",
      },
      prices: {
        "Black": 32000,
        "Acid Washed": 35000,
  ...
  return (
    <ProductSection
      id="products"
      title="💪 Our Tees"
      subtitle="Wear your arrogance. Show your dominance. Only for the elite gymrats."
      products={products}
